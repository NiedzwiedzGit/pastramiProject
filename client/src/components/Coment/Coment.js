                ...
                <div className={classes.Wraper}>
                    <div className={classes.Img}>
                        ...
                        <div className={classes.BtnEdit}>
                            ...
                            {this.props.auth ? <div className={classes.ComentsBlockBtnSwipe}><svg onClick={this.props.clicked} width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-trash" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
